...
const TrendingCard = () => {
  return (
    <div className="relative flex-shrink-0 w-[240px] sm:w-[400px] sm:h-[230px] lg:w-[470px] h-[140px]">
      ...
      <Image src={bkMarkEmpty} alt="logo" className="absolute cursor-pointer top-2 right-2 sm:top-4 sm:right-8 sm:w-[32px] lg:right-6" />
      <Image
        src={beyondEarth}
        alt="logo"
        className="rounded-lg w-full h-full bg-cover bg-center"
      />
      <div className="absolute cursor-pointer bottom-[16px] sm:bottom-6 sm:left-6 left-[16px] flex flex-col gap-1">
        <div className="flex sm:w-[149px] justify-center items-center gap-2 text-white/70 text-[12px] sm:text-[15px] font-normal">
          <h3>2019</h3>
          <svg
