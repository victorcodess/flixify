...
<div className="z-10 absolute cursor-pointer top-2 right-2 sm:top-4 sm:right-4 sm:w-[32px] group">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
          ...
          <g id="Group 27">
            ...
            <g id="Bookmark">
              <path
                ...
                className={`${isBookmarked ? "text-white group-hover:stroke-black group-hover:text-black" : "text-transparent group-hover:stroke-black"}  fill-current`}
                stroke="white"
                strokeWidth="1.5"
              />
            </g>
      ...
      <div className="cursor-pointer flex flex-col gap-1 items-start justify-center  mt-2">
        ...
        <h3 className="text-white font-medium text-[15px] sm:text-[18px]">
          {title}
        </h3>
      </div>
    </div>
